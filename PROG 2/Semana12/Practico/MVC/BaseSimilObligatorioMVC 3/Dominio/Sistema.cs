...
namespace Dominio
{
    public class Sistema
    {
        ...
        private void PrecargarCasas()
        {
            ...
            AgregarCasa(new Casa(10, 14, 1000, 3000, new Direccion("San Jose 1122", ObtenerBarrio(101)), new System.DateTime(2000, 01, 01)));
            AgregarCasa(new Casa(15, 40, 1000, 3000, new Direccion("18 de julio 999 apto 102", ObtenerBarrio(102)), new System.DateTime(2000, 01, 01)));
            AgregarCasa(new Casa(20, 10, 1000, 3000, new Direccion("18 de julio 202 apto 102", ObtenerBarrio(102)), new System.DateTime(2000, 01, 01)));
            AgregarCasa(new Casa(5, 20, 1000, 3000, new Direccion("18 de julio 999 apto 102", ObtenerBarrio(102)), new System.DateTime(2000, 01, 01)));
        }
        ...
        public List<Propiedad> ListadoCasas()
        {
            List<Propiedad> listado = new List<Propiedad>();
            foreach(Propiedad p in propiedades)
            {
                if (p is Casa) listado.Add(p);
            }
            return listado;
        }

        public List<Propiedad> CasasMayorArea(double area)
        {
            List<Propiedad> aux = new List<Propiedad>();
            foreach (Propiedad propiedad in propiedades)
            {
        ...
        public void CambiarNombreDeBarrio(Barrio b, string nombre)
        {
            b.CambiarNombreDeBarrio(nombre);
        }
