...
namespace Dominio
{
    public class Disco : IValidable, IComparable<Disco>
    {
        ...
        public Disco(string codigo, Musico musico, string titulo, int anio, string imagen)
        {
            this._codigo = codigo;
            this._musico = musico;
            this._titulo = titulo;
        ...
        {
            if (!Imagen.EndsWith(".png") && !Imagen.EndsWith(".jpg")) throw new Exception("La imagen tiene que ser png o jpg");
        }
